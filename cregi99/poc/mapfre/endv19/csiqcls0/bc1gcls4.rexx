PROC 0 OPT(3) APPL(CTLI) DF() LL() UP() SP() PP() +
...
/*                                                                   */
/* FUNCTION: THIS CLIST ALLOWS THE USER TO INVOKE ENDEVOR PDM        */
...
/*  TO PERFORM ALL LIBRARY ALLOCATIONS, LIDDEFS FOR PANELS(ISPPLIB)  */
