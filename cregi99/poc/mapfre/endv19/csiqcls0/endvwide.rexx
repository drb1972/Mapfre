...
/* NAME: ENDVWIDE                                                    */
/*                                                                   */
/* PURPOSE: This routine is used to trim the model line variables to */
/* match the available screen width.  It is typically called by the  */
/* 'entry' panel after setting the prefix for the variable names     */
/* (VARPFX) and passes the necessary variables.                      */
/*                                                                   */
/*-------------------------------------------------------------------*/
