...
/* *                  DSN=TSOID1.C1TEMPR_.QZSYSID.MSGS            */
/* *  NOPREFIX        USERID(TSOID1) ->                           */
/* *                  DSN=TSOID1.C1TEMPR_.QZSYSID.MSGS            */
/* *  PREFIX(TSO1D2)  USERID(TSOID1) ->                           */
/* *                  DSN=TSOID2.TSOID1.C1TEMPR_.QZSYSID.MSGS     */
/* ************************************************************** */
...
SET &C1DSN = &STR('&ZUSER..C1TEMPR&ZSCREEN..Q&CPUID..MSGS')
   ELSE +
SET &C1DSN = &STR('&ZPREFIX..&ZUSER..C1TEMPR&ZSCREEN..Q&CPUID..MSGS')
   END
