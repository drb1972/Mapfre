...
//* *==============================================================* *
//* *==============================================================* *
//NDVRSHIP EXEC PGM=NDVRC1,DYNAMNBR=1500,REGION=4096K,
...
//*
//* ******************************************************************
//* *  BULK DATA TRANSFER  U_S_I_N_G  J_E_S  - GENERATED JCL DATASET
//* *  BULK DATA TRANSFER MODEL JCL DATASET
//* ******************************************************************
//*
//C1BMXB1C DD DSN=&&&&XB1C,DISP=(NEW,PASS),SPACE=(TRK,(2,10)),
//            DCB=(RECFM=FB,LRECL=80,DSORG=PS),
//            UNIT=&T@DISK
//C1BMXB1M DD DISP=SHR,
//            DSN=&I@PRFX..&I@QUAL..CSIQOPTN
//*
//*
//* ******************************************************************
//* *  BULK DATA TRANSFER  V_E_R_S_I_O_N  2  COPY/RUN COMMAND DATASETS
//* *  BULK DATA TRANSFER MODEL CONTROL CARD DATASET
//* ******************************************************************
//*
//C1BMXBDC DD DSN=&&&&XBDC,DISP=(NEW,PASS),SPACE=(TRK,(2,10)),
//            DCB=(RECFM=FB,LRECL=80,DSORG=PS),
//            UNIT=&T@DISK
//C1BMXBDM DD DISP=SHR,
//            DSN=&I@PRFX..&I@QUAL..CSIQOPTN               C9223300
//*
//* ******************************************************************
