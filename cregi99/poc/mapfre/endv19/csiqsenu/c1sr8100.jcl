...
)SEL &RPTNUM = RPT64 OR &RPTNUM = RPT65 OR &RPTNUM = RPT66
)SEL &SADTE NE &Z AND &SBDTE NE &Z
     SHIPPED AFTER &SADTE BEFORE &SBDTE .
)ENDSEL
)SEL &SADTE NE &Z AND &SBDTE  = &Z
...
//            UNIT=&T@DISK,SPACE=(CYL,(1,2)),
//            DCB=(RECFM=FB,LRECL=838)
//BSTLST   DD SYSOUT=*
//SORTIN   DD UNIT=&T@DISK,SPACE=(CYL,(150,15))
//SORTOUT  DD UNIT=&T@DISK,SPACE=(CYL,(150,15))
