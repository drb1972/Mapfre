...
//SYSUT2   DD DSN=TTYY.GENEROL.ACPT.DATA,DISP=MOD
//SYSIN    DD DUMMY
/*
//INVSORT   EXEC PGM=SORT                                               00050000
//SORTIN   DD DSN=TTYY.GENEROL.ACPT.DATA,DISP=SHR                       00060008
//SORTOUT  DD DSN=TTYY.GENEROL.ACPT.DATA,DISP=SHR                       00070002
