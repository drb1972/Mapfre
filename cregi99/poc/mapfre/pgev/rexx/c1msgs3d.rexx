...
Send_email:
 ...
 if jowner ^= '' then do
   say 'C1MSGS3: Sending email to' jowner'@DIRECTLINEGROUP.CO.UK'
   queue 'TO:' jowner'@DIRECTLINEGROUP.CO.UK'
 end /* jowner ^= '' */
 if send_to_admin then
   queue 'CC: mapfre.endevor@rsmpartners.com'
...
email_warning:
 ...
 queue 'FROM: mapfre.endevor@rsmpartners.com'
 queue 'TO: mapfre.endevor@rsmpartners.com'
 queue 'TO: mfoperations.in@capgemini.com'
 ...
 queue ' '
 queue 'If you have any concerns please call us on +44 (0)1527 837767'
