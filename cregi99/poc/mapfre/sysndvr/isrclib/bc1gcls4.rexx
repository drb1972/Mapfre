...
/* NAME: BC1GCLS4                                                    */
/*                                                                   */
/* FUNCTION: THIS CLIST ALLOWS THE PDM USER TO INVOKE PDM FROM WITHIN*/
/*  AN ISPF SESSION WITHOUT PREALLOCATING THE PDM LIBRARIES TO THE   */
/*  STANDARD ISPF LIBRARY DEFINITIONS.  THE CLIST USES THE ISPF      */
/*  LIBDEF SERVICE TO ALLOCATE ALTERNATE LOAD, PANEL, MESSAGE AND    */
/*  SKELETON DATASETS.                                               */
...
/*-------------------------------------------------------------------*/
/* USE THE ISPF LIBDEF SERVICE TO DEFINE ALTERNATE LOAD, PANEL,      */
/* MESSAGE AND SKELETON LIBRARIES.                                   */
/*-------------------------------------------------------------------*/
ISPEXEC LIBDEF ISPLLIB DATASET ID -
        ( -
        'TSOXX4.ENDEVOR.V16.CSIQAUTU' -
        'TSOXX4.ENDEVOR.V16.CSIQAUTH' -
        )
...
/*-------------------------------------------------------------------*/
/* INVOKE THE PDM DIALOG DRIVER.                                     */
/*-------------------------------------------------------------------*/
ISPEXEC SELECT PGM(BC1G1000) NOCHECK NEWAPPL(CTLI) PASSLIB
