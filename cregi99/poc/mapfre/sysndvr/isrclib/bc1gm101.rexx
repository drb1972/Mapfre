...
/* NAME: WIPLDEL                                                     */
/*                                                                   */
/* FUNCTION: THIS ISPF/PDF EDIT MACRO IS USED TO SUPPORT THE WIPLDEL */
/* COMMAND.  THE WIPLDEL COMMAND WILL ALLOW THE USER TO LOGICALLY    */
/* DELETE THOSE LINES THAT ARE TO BE INSERTED BY THE SPECIFIED FILES.*/
/* A WIP LINE IS LOGICALLY DELETED BY PLACING AN ASTERICK IN COLUMN  */
/* ONE OF THE WIP FILE.                                              */
/*                                                                   */
/* SYNTAX: THE SYNTAX OF THE WIPLDEL COMMAND IS                      */
/*    WIPLDEL FILE_ID FILE_ID ...                                    */
/*                                                                   */
...
/* MESSAGE WILL BE DISPLAYED AND THE WIPLDEL COMMAND WILL TERMINATE. */
...
ISREDIT CHANGE P'=' '*' ALL CHARS NX 1
ISREDIT (TCHGCNT) = CHANGE_COUNTS
SET &CHGCNT = &TCHGCNT
SET &ZEDSMSG = &STR(&CHGCNT LINES DELETED)
SET &ZEDLMSG = &STR(&CHGCNT LINES HAVE BEEN LOGICALLY DELETED)
ISPEXEC SETMSG MSG(ISRZ001)
