...
/* *                  DSN=TSOID1.C1TEMPR_.EZSYSID.MSGS            */
/* *  NOPREFIX        USERID(TSOID1) ->                           */
/* *                  DSN=TSOID1.C1TEMPR_.EZSYSID.MSGS            */
/* *  PREFIX(TSO1D2)  USERID(TSOID1) ->                           */
/* *                  DSN=TSOID2.TSOID1.C1TEMPR_.EZSYSID.MSGS     */
/* ************************************************************** */
...
SET &C1DSN = &STR('&ZUSER..C1TEMPR&ZSCREEN..E&CPUID..MSGS')
   ELSE +
SET &C1DSN = &STR('&ZPREFIX..&ZUSER..C1TEMPR&ZSCREEN..E&CPUID..MSGS')
   END
